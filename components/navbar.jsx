...
import { Code, Folder, House, Info, Menu, Phone, } from "lucide-react";
...
export default function Navbar() {
    ...
    return (
        <motion.header
            ...
            className="fixed top-0 left-0 w-full z-50 backdrop-blur-sm bg-background/60 border-b max-h-16"
        >
